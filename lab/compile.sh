...
c++ -std=c++11 -Wall -g3 -ggdb -gdwarf-3 -fsanitize=address -I. -o EXE pointers.cc `root-config --cflags --libs`  #1> ../output/compile_output.txt #2> ../output/compile_errors.txt
