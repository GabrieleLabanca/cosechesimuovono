...
c++ -Wall -g3 -ggdb -gdwarf-3 -fsanitize=address -I. -I./living -I./world -o EXE *.cc world/*.cpp `root-config --cflags --libs`  #1> ../output/compile_output.txt #2> ../output/compile_errors.txt
